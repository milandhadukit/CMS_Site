        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form  action="{{ route('store-deparment') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label class="label"> Title: </label>
                                <input type="text" name="title_department" class="form-control" required />
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description_department" rows="2" cols="30" class="form-control" ></textarea>
